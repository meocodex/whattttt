...
export const getBodyMessage = (msg: proto.IWebMessageInfo): string | null => {
  ...
  try {
    ...
    if (!objKey) {
      logger.warn(`0000 Nao achou o type 152: ${type}
${JSON.stringify(msg)}`);
...
const isValidMsg = (msg: proto.IWebMessageInfo): boolean => {
  ...
  try {
    ...
    if (!ifType) {
      logger.warn(`0000 Nao achou o type em isValidMsg: ${msgType}
                        ...
                        try {
                          ...
                          if (bloqueado === 'sim') {
                            ...
                            axios.request(optionsdesbloq).then(async function (response) {
                              ...
                              const bodyfinaliza = { text: formatBody(`Opss! Algo de errado aconteceu! Digite *0* para voltar ao menu anterior e fale com um atendente!`, contact) };
                    ...
                    if (totalCount_overdue === 0) {
                      ...
                      axios.request(optionsPENDING).then(async function (response) {
                        ...
                        axios.request(optionsGetPIX).then(async function (response) {
                          ...
                          const body = {
                            text: formatBody(`*Opss!!!!*\nOcorreu um erro! Digite *0* e fale com um *Atendente*!`, contact),
                          };
                          await sleep(2000)
                          await wbot.sendMessage(`${ticket.contact.number}@${ticket.isGroup ? "g.us" : "s.whatsapp.net"}`, body);
                        });
                            ...
                            axios.request(optionsdesbloqeuio).then(async function (response) {
                              ...
                              if (tipo === 'sucesso') {
                                ...
                                const bodyerroatendent = {
                                  text: formatBody(`Digite *0* para voltar o menu e fale com um atendente!`, contact),
                                };
                                await sleep(2000)
                              ...
                              const bodyerro = {
                                text: formatBody(`Ops! Ocorreu um erro digite *0* e fale com um atendente!`, contact),
                              };
                              await sleep(2000)
                              await wbot.sendMessage(`${ticket.contact.number}@${ticket.isGroup ? "g.us" : "s.whatsapp.net"}`, bodyerro);
                            });
                          ...
                          if (status_internet !== 'A') {
                            ...
                            axios.request(optionsdesbloqeuio).then(async function (response) {
                              ...
                              if (tipo === 'sucesso') {
                                ...
                                const bodyerro = {
                                  text: formatBody(`Ops! Ocorreu um erro e nao consegui desbloquear! Digite *0* e fale com um atendente!`, contact),
                                };
                                await sleep(2000)
                                await wbot.sendMessage(`${ticket.contact.number}@${ticket.isGroup ? "g.us" : "s.whatsapp.net"}`, bodyerro);
                              }
                      ...
                      axios.request(optionsdesbloqeuio).then(async function (response) {
                        ...
                        if (tipo === 'sucesso') {
                          ...
                          const bodyerroatendente = {
                            text: formatBody(`Digite *0* e fale com um atendente!`, contact),
                          };
                          await sleep(2000)
                          await wbot.sendMessage(`${ticket.contact.number}@${ticket.isGroup ? "g.us" : "s.whatsapp.net"}`, bodyerroatendente);
                        } /* else {
                                   const bodyerro = {
                    text: formatBody(`Ops! Ocorreu um erro e nao consegui desbloquear! Digite *0* e fale com um atendente!`
                                   await sleep(2000)
                                   await wbot.sendMessage(`${ticket.contact.number}@${ticket.isGroup ? "g.us" : "s.whatsapp.net"}`,bodyerro);  
                               } */
